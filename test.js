...
test("expected errors", () => {
  ...
  return exec.shell("tsc -p . --noEmit").catch(err => {
    expect(err.message).toMatchInlineSnapshot(`
      ...
      test.ts(27,20): error TS2345: Argument of type 'unknown' is not assignable to parameter of type 'never'.
      ...
      test.ts(31,8): error TS2345: Argument of type 'any[]' is not assignable to parameter of type '\\"❌ Right type is not assignable to left type\\"'.
      test.ts(32,8): error TS2345: Argument of type 'readonly any[]' is not assignable to parameter of type '\\"❌ Left type is not assignable to right type\\"'.
      test.ts(35,8): error TS2345: Argument of type 'never[]' is not assignable to parameter of type '\\"❌ Left type is not assignable to right type\\"'.
      test.ts(36,8): error TS2345: Argument of type '[never]' is not assignable to parameter of type '\\"❌ Right type is not assignable to left type\\"'.
      "
    `);
  });
});
